  ...
  $(document).ready(function () {
    ...
    $(window).on("load", function () {
      $(".home-search-slider-headlines").each(function () {
        var carouselHeadlineHeight = $(this).height()/2;
        $(this).css("padding-bottom", carouselHeadlineHeight);
      });
    ...
    var $tabsNav2 = $(".tabs-nav"),
      $tabsNavLis2 = $tabsNav2.children("li");

    $tabsNav2.each(function () {
      var $this = $(this);
    ...
    $tabsNavLis2.on("click", function (e) {
      var $this = $(this);
    ...
    $(".toggle-container").each(function (i, item) {
      $(".toggle-container:gt(" + i + ")").hide();
    });
    ...
    function newMenuItem() {
      newElem = $("tr.pricing-list-item.pattern").first().clone();
    ...
    if ($("table#pricing-list-container").is("*")) {
      ...
      $(document).on("click", "#pricing-list-container .delete", function (e) {
        e.preventDefault();
        if ($(".fm-input.pricing-name input").length > 1) {
